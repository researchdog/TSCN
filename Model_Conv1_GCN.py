...
class Gcn_1nn1(nn.Module):
    ...
    def __init__(self):
        ...
        self.liner1 = nn.Linear(10560, 120)
    ...
    def forward(self,adjacency,h):
        ...
        #h= self.conv3(h)
        """图卷积层"""
        h_g1=F.relu(self.gcn1(adjacency,h,h.shape[2]))
        h_g2=F.relu(self.gcn2(adjacency,h_g1,h.shape[2]))
        #h_g3=F.relu(self.gcn3(adjacency,h_g2,h.shape[2]))
        #h_g4=F.relu(self.gcn4(adjacency,h_g3,h.shape[2]))
        h=h_g2
